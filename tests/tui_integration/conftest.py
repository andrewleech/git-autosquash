...
def sample_diff_hunks() -> List[DiffHunk]:
    ...
    return [
        ...
        DiffHunk(
            ...
            context_after=["    #endif", "    // Continue with execution"],
        ),
        DiffHunk(
...
@pytest.fixture
def blame_matched_mappings(
    sample_diff_hunks, sample_commits
    ...
    return [
        HunkTargetMapping(
            ...
            fallback_candidates=[
                ...
                "a9024949e3c8f2d4b6e1a7f8c9d0e2f3b4a5c6d7",
            ],
...
@pytest.fixture
def mixed_mappings(
    blame_matched_mappings, fallback_mappings
) -> List[HunkTargetMapping]:
    ...
    for i in range(50):
        ...
        if i % 3 == 0:  # Fallback scenario
            mapping = HunkTargetMapping(
                ...
                fallback_candidates=[
                    sample_commits[0].commit_hash,
                    sample_commits[1].commit_hash,
                ],
                needs_user_selection=True,
            )
        else:  # Blame match
