...
class TestSnapshotRegression:
    ...
    async def test_fallback_only_layout(
        ...
        assert await snap_compare(
            app, terminal_size=(100, 30), run_before=lambda pilot: pilot.pause(0.2)
        )
    ...
    async def test_mixed_hunks_layout(
        ...
        assert await snap_compare(
            app, terminal_size=(120, 35), run_before=lambda pilot: pilot.pause(0.2)
        )
    ...
    async def test_small_terminal_layout(
        ...
        assert await snap_compare(
            app, terminal_size=(60, 20), run_before=lambda pilot: pilot.pause(0.2)
        )
    ...
    async def test_large_terminal_layout(
        ...
        assert await snap_compare(
            app, terminal_size=(150, 45), run_before=lambda pilot: pilot.pause(0.2)
        )
    ...
    async def test_wide_terminal_layout(
        ...
        assert await snap_compare(
            app, terminal_size=(200, 30), run_before=lambda pilot: pilot.pause(0.2)
        )
    ...
    async def test_scrolled_state_many_hunks(
        ...
        assert await snap_compare(app, terminal_size=(100, 25), run_before=scroll_down)
    ...
    async def test_hunk_selection_state(
        ...
        assert await snap_compare(
            app, terminal_size=(120, 30), run_before=select_second_hunk
        )
    ...
    async def test_approve_toggle_state(
        ...
        assert await snap_compare(
            app, terminal_size=(100, 30), run_before=toggle_approve_all
        )
    ...
    async def test_ignore_toggle_state(
        ...
        assert await snap_compare(
            app, terminal_size=(100, 30), run_before=toggle_ignore_all
        )
    ...
    async def test_batch_modal_opened(
        ...
        assert await snap_compare(
            app, terminal_size=(120, 35), run_before=open_batch_modal
        )
    ...
    async def test_radio_button_selection(
        ...
        assert await snap_compare(
            app, terminal_size=(100, 30), run_before=select_different_commit
        )
    ...
    async def test_diff_viewer_content(
        ...
        assert await snap_compare(
            app, terminal_size=(120, 30), run_before=select_hunk_show_diff
        )
    ...
    async def test_progress_summary_updates(
        ...
        assert await snap_compare(
            app, terminal_size=(100, 30), run_before=change_selections
        )
...
class TestThemeVariations:
    ...
    async def test_merge_commit_styling(
        ...
        merge_commit = next(
            (c for c in sample_commits if c.is_merge), sample_commits[0]
        )
