...
class TestLayoutResponsivenessDemo:
    ...
    async def test_responsiveness_summary(self, mock_commit_history_analyzer):
        ...
        for width, height, label in test_sizes:
            ...
            async with app.run_test(size=(width, height)) as pilot:
                ...
                panel_width_total = result["hunk_panel_width"] + result["diff_panel_width"]
        ...
        for result in results:
            print(f"{result['label'].upper():>6} ({result['size']:>7}): "
        ...
        position_variance = max(button_positions_from_bottom) - min(button_positions_from_bottom)
        ...
        print(f"✓ Button positions consistent: {button_positions_from_bottom} rows from bottom")
    ...
    async def test_layout_structure_is_optimal(self, mock_commit_history_analyzer):
        ...
        async with app.run_test(size=(80, 24)) as pilot:
            ...
            print(f"  - Panel split: {hunk_panel.region.width}w + {diff_panel.region.width}w")